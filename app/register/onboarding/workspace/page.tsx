import { OnboardingWorkspaceForm } from '@/components/register/onboarding-workspace-form';
import { OnboardingWorkspacePreview } from '@/components/register/onboarding-workspace-preview';
